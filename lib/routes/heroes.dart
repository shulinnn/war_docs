...
class HeroesRoute extends StatefulWidget {
  const HeroesRoute({super.key});

  @override
  State<StatefulWidget> createState() => _StateHeroes();
}

class _StateHeroes extends State<HeroesRoute> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
            ...
            child: FutureBuilder(
                future: ApiService()
                    .getHeroes(Provider.of<RaceProvider>(context).race as int),
