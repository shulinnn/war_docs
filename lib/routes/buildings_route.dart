...
class BuildingsRoute extends StatefulWidget {
  const BuildingsRoute({super.key});

  @override
  State<StatefulWidget> createState() => _StateBuildings();
}

class _StateBuildings extends State<BuildingsRoute> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
            ...
            child: FutureBuilder(
                future: ApiService().getBuildings(
                    Provider.of<RaceProvider>(context).race as int),
